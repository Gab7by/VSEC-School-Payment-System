        ...
        <div className="flex flex-col gap-3 sm:items-end">
          ...
          {stats && (
            <button
              ...
              disabled={stats.totalPaid === 0}
              className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-rose-600 border border-rose-300 rounded-xl hover:bg-rose-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
            >
